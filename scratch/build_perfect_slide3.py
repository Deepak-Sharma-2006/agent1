...
def generate_bhedak_slide_3_html():
    return """    case 3:
      return `<!DOCTYPE html>
<html>
<head>
  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <div style="display:grid; grid-template-columns: 1fr 44px 1.05fr 44px 1.15fr; align-items:center;">
          
          <!-- Node 1: Starting Point (Darknet Sources) -->
          <div class="flow-node" style="border:2px solid #7D4698; border-top:5px solid #7D4698;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">1. Darknet & Surface Ingestion</strong>
              <div style="font-size:12px; font-weight:700; color:#6B21A8; margin-bottom:8px;">Tor Marketplaces • Paste Dumps • MTProto Feeds</div>
              
              <div style="font-size:12.5px; color:#334155; line-height:1.42; display:flex; flex-direction:column; gap:4px;">
          ...
          <div class="connector-box">
            <div class="connector-arrow" style="color:#7D4698;">➔</div>
            <div class="connector-label">Raw Feeds</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #0284C7; border-top:5px solid #0284C7;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">TECHINT Ingestion Operator</strong>
          ...
          <!-- Connector 2 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#0284C7;">➔</div>
            <div class="connector-label">Origin IP</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #2563EB; border-top:5px solid #2563EB;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Multi-Market Graph & AI Stylometry</strong>
        ...
        <div style="display:grid; grid-template-columns: 1.05fr 44px 1.05fr 44px 1.15fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #4F46E5; border-top:5px solid #4F46E5;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Cyber Forensic Examiner</strong>
          ...
          <!-- Connector 3 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#4F46E5;">➔</div>
            <div class="connector-label">Dossier</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #DC2626; border-top:5px solid #DC2626;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Centre Director</strong>
          ...
          <!-- Connector 4 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#DC2626;">➔</div>
            <div class="connector-label">Sec 193 BNSS</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #059669; border-top:5px solid #059669;">
            <div>
              ...
              <strong style="font-size:17.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Court Evidence Package</strong>
    ...
    <div>
      ...
      <!-- 4 Architectural Domain Cards Grid (Height: ~148px) -->
      <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:12px;">
        
        <!-- Domain 1: Ingestion Fleet -->
        <div class="arch-card" style="border-left:4px solid #0284C7;">
          <div>
        ...
        <div class="arch-card" style="border-left:4px solid #4F46E5;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
        ...
        <div class="arch-card" style="border-left:4px solid #059669;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
        ...
        <div class="arch-card" style="border-left:4px solid #DC2626;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
...
def generate_chakra_slide_3_html():
    return """    case 3:
      return `<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <!-- Main Visual Graph Canvas: 2 Rows of 4 Nodes = 8 Stages Total -->
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        
        <!-- ROW 1: CITIZEN INGESTION ➔ IO SEEDING ➔ ENGINE CORE ➔ FORENSIC AUDIT (4 Nodes) -->
        <div style="display:grid; grid-template-columns: 1fr 32px 1fr 32px 1.05fr 32px 1fr; align-items:center;">
          
          <!-- Node 1: Citizen 1930 Intake -->
          <div class="flow-node" style="border:2px solid #7D4698; border-top:5px solid #7D4698;">
            <div>
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:3px;">
                <span class="step-pill" style="background:#7D4698;">NODE 01 • INGESTION</span>
                <span style="font-size:10.5px; font-weight:800; color:#7D4698;">NCRP 1930 PORTAL</span>
              </div>
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">1. Citizen FIR & 1930 Ingestion</strong>
              <div style="font-size:11px; font-weight:700; color:#6B21A8; margin-bottom:6px;">Victim Cyber Complaint • ₹45L Loss • UPI ID</div>
          ...
          <div class="connector-box">
            <div class="connector-arrow" style="color:#7D4698;">➔</div>
            <div class="connector-label">FIR Hash</div>
          </div>

          <!-- Node 2: RBAC Tier 1 - Case IO -->
          <div class="flow-node" style="border:2px solid #0284C7; border-top:5px solid #0284C7;">
            <div>
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:3px;">
              ...
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Investigating Officer (IO)</strong>
              <div style="font-size:11px; color:#64748B; margin-bottom:6px;">Sub-Inspector / Inspector • Cyber Police Station</div>
            ...
            <div class="hand-off-bar" style="background:#F0F9FF; border:1px solid #BAE6FD; color:#0284C7;">
              ...
              <span>Tagged Seed Wallet ➔ Triggers Auto-Trace</span>
            </div>
          </div>
          ...
          <div class="connector-box">
            <div class="connector-arrow" style="color:#0284C7;">➔</div>
            <div class="connector-label">Seed Wallet</div>
          </div>

          <!-- Node 3: Core Multi-Chain Engine Core -->
          <div class="flow-node" style="border:2px solid #2563EB; border-top:5px solid #2563EB;">
            <div>
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:3px;">
                <span class="step-pill" style="background:#2563EB;">NODE 03 • ENGINE CORE</span>
                <span style="font-size:10.5px; font-weight:800; color:#2563EB;">RUST BFS + TRON gRPC</span>
              </div>
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Multi-Chain Tracing Engine</strong>
              <div style="font-size:11px; font-weight:700; color:#1D4ED8; margin-bottom:6px;">Zero-Allocation BFS • 5 Hops in &lt;180s • 4-Pillar Math</div>
          ...
          <!-- Connector 3 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#2563EB;">➔</div>
            <div class="connector-label">Hot Wallet</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #4F46E5; border-top:5px solid #4F46E5;">
            <div>
              ...
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Forensic Investigator</strong>
              <div style="font-size:11px; color:#64748B; margin-bottom:6px;">Inspector • State Cyber Crime Cell / FSL</div>
        ...
        <!-- ROW 2: SANCTION SP ➔ VASP DESK ➔ NCFL FORENSIC ➔ COURT RESTITUTION (4 Nodes) -->
        <div style="display:grid; grid-template-columns: 1fr 32px 1fr 32px 1.05fr 32px 1fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #DC2626; border-top:5px solid #DC2626;">
            <div>
              ...
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Supervisory Sanction SP</strong>
              <div style="font-size:11px; color:#64748B; margin-bottom:6px;">DySP / ACP / SP (Sec 78 IT Act 2000)</div>
          ...
          <div class="connector-box">
            <div class="connector-arrow" style="color:#DC2626;">➔</div>
            <div class="connector-label">Sec 106 Freeze</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #D97706; border-top:5px solid #D97706;">
            <div>
              ...
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">VASP Compliance Desk</strong>
              <div style="font-size:11px; color:#64748B; margin-bottom:6px;">Registered Exchange (CoinDCX / Binance Desk)</div>
          ...
          <!-- Connector 5 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#D97706;">➔</div>
            <div class="connector-label">Assets Locked</div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #059669; border-top:5px solid #059669;">
            <div>
              ...
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Forensic Attestation & CTI</strong>
              <div style="font-size:11px; color:#64748B; margin-bottom:6px;">State FSL Scientist + I4C Threat Analytics Unit</div>
          ...
          <!-- Connector 6 -->
          <div class="connector-box">
            <div class="connector-arrow" style="color:#059669;">➔</div>
            <div class="connector-label">Court Docket</div>
          </div>

          <!-- Node 8: Terminal Statutory Outcome & Restitution -->
          <div class="flow-node" style="border:2px solid #047857; border-top:5px solid #047857;">
            <div>
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:3px;">
                ...
                <span style="font-size:10.5px; font-weight:800; color:#047857;">SPECIAL CYBER COURT</span>
              </div>
              <strong style="font-size:15.5px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Trial & Capital Restitution</strong>
              <div style="font-size:11px; font-weight:700; color:#047857; margin-bottom:6px;">BSA 2023 Sec 63 & BNSS 107 Restitution</div>
              
              <div style="font-size:12px; color:#334155; line-height:1.38; display:flex; flex-direction:column; gap:3px;">
                <div>• <strong>100% Admissible Evidence:</strong> Electronic certificate admits on-chain trace without hostile witness risk.</div>
                <div>• <strong>Capital Restitution:</strong> Court orders frozen funds refunded directly to victim bank accounts.</div>
                <div>• <strong>Speedy Judicial Conviction:</strong> Tamper-proof provenance under BNSS Sec 193 & 207.</div>
              </div>
            </div>

            <div class="hand-off-bar" style="background:#ECFDF5; border:1px solid #A7F3D0; color:#047857;">
              <span>Judicial Outcome:</span>
              <span>Capital Restitution + Instant Conviction</span>
            </div>
          </div>
      ...
      <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:12px;">
        ...
        <div class="arch-card" style="border-left:4px solid #0284C7;">
          <div>
            ...
            <div style="font-size:11px; color:#334155; line-height:1.3; margin-bottom:4px;">
              Normalizes Bitcoin UTXO, TRC-20, & Ethereum transactions into canonical UTDM with sub-15ms block parsing.
            </div>
            <div style="font-size:10.5px; font-weight:800; color:#0369A1; background:#F0F9FF; padding:2px 5px; border-radius:3px; margin-bottom:5px;">
...
def main():
    bhedak_path = r"scripts/engine/generate_bhedak_slides.mjs"
    chakra_path = r"scripts/engine/generate_chakra_slides.mjs"

    # 1. Update Bhedak
    with open(bhedak_path, "r", encoding="utf-8") as f:
        bhedak_content = f.read()

    new_bhedak_slide_3 = generate_bhedak_slide_3_html()
    pattern = r"    case 3:\s+return `<!DOCTYPE html>.*?</html>`;"
    updated_bhedak = re.sub(pattern, new_bhedak_slide_3, bhedak_content, flags=re.DOTALL)

    with open(bhedak_path, "w", encoding="utf-8") as f:
        f.write(updated_bhedak)
    print("[Success] Injected master Slide 3 into generate_bhedak_slides.mjs")

    # 2. Update Chakra
    with open(chakra_path, "r", encoding="utf-8") as f:
        chakra_content = f.read()

    new_chakra_slide_3 = generate_chakra_slide_3_html()
    updated_chakra = re.sub(pattern, new_chakra_slide_3, chakra_content, flags=re.DOTALL)

    with open(chakra_path, "w", encoding="utf-8") as f:
        f.write(updated_chakra)
    print("[Success] Injected master Slide 3 into generate_chakra_slides.mjs")
