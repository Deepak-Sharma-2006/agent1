  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <!-- ROW 1: CITIZEN INGESTION ➔ IO SEEDING ➔ ENGINE CORE ➔ FORENSIC AUDIT (4 Nodes with 38px Connectors) -->
...
def main():
    ...
    print("[Success] Injected v3 Slide 3 into generate_bhedak_slides.mjs")
    ...
    print("[Success] Injected v3 Slide 3 into generate_chakra_slides.mjs")
