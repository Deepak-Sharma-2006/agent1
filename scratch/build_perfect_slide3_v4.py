  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <!-- ROW 1: INGESTION & CORE ENGINE PHASE (3 Nodes with 52px Connector Clearance) -->
        <div style="display:grid; grid-template-columns: 1fr 52px 1.05fr 52px 1.15fr; align-items:center;">
        ...
        <!-- ROW 2: FORENSIC CERTIFICATION, SANCTION & COURT PHASE (3 Nodes with 52px Connector Clearance) -->
        <div style="display:grid; grid-template-columns: 1.05fr 52px 1.05fr 52px 1.15fr; align-items:center;">
    ...
    <div>
      ...
      <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:12px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #0284C7;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Distributed Crawler Fleet</strong>
              <span style="font-size:11px; font-weight:800; background:#E0F2FE; color:#0369A1; padding:2px 6px; border-radius:3px;">NIC MEGHRAJ</span>
            </div>
        ...
        <div class="tech-col-card" style="border-left:4px solid #4F46E5;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Air-Gapped Backend Enclave</strong>
              <span style="font-size:11px; font-weight:800; background:#EEF2FF; color:#4338CA; padding:2px 6px; border-radius:3px;">MEGHRAJ SCIF</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #059669;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">AI Stylometry & NLP Lab</strong>
              <span style="font-size:11px; font-weight:800; background:#ECFDF5; color:#065F46; padding:2px 6px; border-radius:3px;">0.65 AI CAP</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
              Neural author verification matching 400+ writeprints with 24-hr UTC diurnal sleep trough timezone inference.
            </div>
            <div style="font-size:11px; font-weight:800; color:#047857; background:#ECFDF5; padding:2.5px 6px; border-radius:3px; margin-bottom:5px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #DC2626;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Sovereign Security & LEA Portals</strong>
              <span style="font-size:11px; font-weight:800; background:#FEF2F2; color:#991B1B; padding:2px 6px; border-radius:3px;">SEC 63 BSA</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
              High-performance WebGL graph visualizer, statutory portal, and FIPS 140-3 HSM cryptographic root of trust.
            </div>
            <div style="font-size:11px; font-weight:800; color:#B91C1C; background:#FEF2F2; padding:2.5px 6px; border-radius:3px; margin-bottom:5px;">
  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <!-- ROW 1: INGESTION ➔ IO ➔ RUST ENGINE ➔ FORENSIC EXAMINER (4 Nodes with 38px Connectors) -->
        <div style="display:grid; grid-template-columns: 1fr 38px 1fr 38px 1.05fr 38px 1fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #7C3AED; border-top:5px solid #7C3AED;">
            <div>
              ...
              <div style="font-size:11px; font-weight:700; color:#7C3AED; margin-bottom:6px;">Victim Cyber Complaint • ₹45L Loss • UPI ID</div>
        ...
        <!-- ROW 2: SANCTION SP ➔ VASP DESK ➔ NCFL FORENSIC ➔ COURT RESTITUTION (4 Nodes with 38px Connectors) -->
        <div style="display:grid; grid-template-columns: 1fr 38px 1fr 38px 1.05fr 38px 1fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #047857; border-top:5px solid #047857;">
            <div>
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:3px;">
                ...
                <span style="font-size:11px; font-weight:800; color:#047857;">SPECIAL CYBER COURT</span>
              </div>
    ...
    <div>
      ...
      <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:12px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #0284C7;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Multi-Chain Ingest & Streams</strong>
              <span style="font-size:11px; font-weight:800; background:#E0F2FE; color:#0369A1; padding:2px 6px; border-radius:3px;">10,000 TX/S</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #059669;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Graph Intelligence & Scoring</strong>
              <span style="font-size:11px; font-weight:800; background:#ECFDF5; color:#065F46; padding:2px 6px; border-radius:3px;">&lt; 180S SEARCH</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
        ...
        <div class="tech-col-card" style="border-left:4px solid #DC2626;">
          <div>
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:2px;">
              <strong style="font-size:14.5px; color:#0F172A; font-weight:900;">Sovereign Security & LEA Portals</strong>
              <span style="font-size:11px; font-weight:800; background:#FEF2F2; color:#991B1B; padding:2px 6px; border-radius:3px;">BNSS 106/107</span>
            </div>
            <div style="font-size:11.5px; color:#334155; line-height:1.32; margin-bottom:4px;">
...
def update_file(filepath, new_case_code):
    with open(filepath, "r", encoding="utf-8") as f:
        content = f.read()

    # Pattern to match case 3: up to case 4:
    pattern = r"(    case 3:\n)(.*?)(    case 4:)"
    
    replacement = new_case_code + "\n" + r"\3"
    ...
    if new_content == content:
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(new_content)
        print(f"SUCCESSFULLY UPDATED Slide 3 in {filepath}")

if __name__ == "__main__":
    bhedak_file = "scripts/engine/generate_bhedak_slides.mjs"
    chakra_file = "scripts/engine/generate_chakra_slides.mjs"
    
    update_file(bhedak_file, generate_bhedak_slide_3())
    update_file(chakra_file, generate_chakra_slide_3())
