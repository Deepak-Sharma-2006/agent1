  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <!-- ROW 1: INGESTION & CORE ENGINE PHASE (3 Nodes with 60px Connectors) -->
        <div style="display:grid; grid-template-columns: 1fr 60px 1.05fr 60px 1.15fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #7D4698; border-top:5px solid #7D4698;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">1. Darknet & Surface Ingestion</strong>
              <div style="font-size:12px; font-weight:700; color:#6B21A8; margin-bottom:8px;">Tor Marketplaces • Paste Dumps • MTProto Feeds</div>
              
              <div style="font-size:13px; color:#334155; line-height:1.42; display:flex; flex-direction:column; gap:4px;">
          ...
          <div class="connector-box">
            <div class="connector-circle" style="border:2.5px solid #7D4698; color:#7D4698;">➔</div>
          ...
          <div class="flow-node" style="border:2px solid #0284C7; border-top:5px solid #0284C7;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">TECHINT Ingestion Operator</strong>
          ...
          <div class="flow-node" style="border:2px solid #2563EB; border-top:5px solid #2563EB;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Multi-Market Graph & AI Stylometry</strong>
        ...
        <!-- ROW 2: FORENSIC CERTIFICATION, SANCTION & COURT PHASE (3 Nodes with 60px Connectors) -->
        <div style="display:grid; grid-template-columns: 1.05fr 60px 1.05fr 60px 1.15fr; align-items:center;">
          ...
          <div class="flow-node" style="border:2px solid #4F46E5; border-top:5px solid #4F46E5;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Cyber Forensic Examiner</strong>
          ...
          <div class="flow-node" style="border:2px solid #DC2626; border-top:5px solid #DC2626;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Centre Director</strong>
            ...
            <div class="hand-off-bar" style="background:#FEF2F2; border:1px solid #FECACA; color:#B91C1C;">
              ...
              <span>Authorized Case File for Cyber Court Submission</span>
            </div>
          </div>
          ...
          <div class="flow-node" style="border:2px solid #059669; border-top:5px solid #059669;">
            <div>
              ...
              <strong style="font-size:18px; color:#0F172A; display:block; font-weight:900; line-height:1.2; margin-bottom:2px;">Court Evidence Package</strong>
  ...
  <div class="slide-3-container">
    ...
    <div style="margin-bottom:8px;">
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:10px 14px; display:flex; flex-direction:column; gap:8px; box-shadow:0 3px 10px rgba(15,23,42,0.03);">
        ...
        <!-- ROW 1: CITIZEN INGESTION ➔ IO SEEDING ➔ ENGINE CORE ➔ FORENSIC AUDIT (4 Nodes with 44px Connectors) -->
        <div style="display:grid; grid-template-columns: 1fr 44px 1fr 44px 1.05fr 44px 1fr; align-items:center;">
          ...
          <!-- Connector 1 -->
          <div class="connector-box">
            <div class="connector-circle" style="border:2px solid #7D4698; color:#7D4698;">➔</div>
          ...
          <div class="connector-box">
            ...
            <div class="connector-label">Seed Tag</div>
          </div>
        ...
        <!-- ROW 2: SANCTION SP ➔ VASP DESK ➔ NCFL FORENSIC ➔ COURT RESTITUTION (4 Nodes with 44px Connectors) -->
        <div style="display:grid; grid-template-columns: 1fr 44px 1fr 44px 1.05fr 44px 1fr; align-items:center;">
          ...
          <div class="connector-box">
            ...
            <div class="connector-label">Sec 106</div>
          </div>
          ...
          <div class="connector-box">
            ...
            <div class="connector-label">Assets</div>
          </div>
          ...
          <div class="connector-box">
            ...
            <div class="connector-label">Docket</div>
          </div>
...
def main():
    ...
    new_bhedak_slide_3 = generate_bhedak_slide_3()
    ...
    print("[Success] Injected updated Slide 3 into generate_bhedak_slides.mjs")

    # 2. Update Chakra
    with open(chakra_path, "r", encoding="utf-8") as f:
        chakra_content = f.read()

    new_chakra_slide_3 = generate_chakra_slide_3()
    ...
    print("[Success] Injected updated Slide 3 into generate_chakra_slides.mjs")
