...
def create_bhedak_deck():
    # Slide 1: Approved SIH Title Page layout
    slide_1 = """case 1:
      return `<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="slide-1-container">
    <!-- Header with SIH Logo at Top Right (Slide 2 Master Header Match) -->
    ...
    # Slide 2: Master Source of Truth (Pure White, Indomitus Oval, 54px Title, 98px SIH Logo, 42px Footer)
    slide_2 = """case 2:
      return `<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="slide-2-container">
    ...
    # Slide 3: Extracted directly from update_slide3_files.py, updated with solid blue 42px footer and clearance
    from update_slide3_files import bhedak_slide_3_html
    slide_3 = bhedak_slide_3_html.replace('padding: 16px 36px 18px 36px;', 'padding: 14px 36px 42px 36px;')
    ...
    # Slide 4: FEASIBILITY AND VIABILITY (Large fonts >= 14.5px, dense card layout, zero dead space)
    slide_4 = """case 4:
      return `<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="slide-4-container">
    ...
    <!-- Main 2-Column Grid -->
    <div style="display:grid; grid-template-columns: 47% 53%; gap:28px; flex:1; margin-bottom:12px; align-items:stretch;">
      ...
      <div style="display:flex; flex-direction:column; justify-content:space-between; height:100%;">
        ...
        <div style="display:flex; flex-direction:column; gap:12px; flex:1; justify-content:space-between; margin-bottom:12px;">
          ...
          <div class="feasibility-card" style="border-left:5px solid #2563EB;">
            ...
            <div>
              <strong style="font-size:20px; font-weight:900; color:#0F172A; display:block; margin-bottom:4px;">Technical Feasibility</strong>
              <div style="font-size:15px; font-weight:600; color:#334155; line-height:1.48;">
          ...
          <div class="feasibility-card" style="border-left:5px solid #059669;">
            ...
            <div>
              <strong style="font-size:20px; font-weight:900; color:#0F172A; display:block; margin-bottom:4px;">Operational Feasibility</strong>
              <div style="font-size:15px; font-weight:600; color:#334155; line-height:1.48;">
          ...
          <div class="feasibility-card" style="border-left:5px solid #D97706;">
            ...
            <div>
              <strong style="font-size:20px; font-weight:900; color:#0F172A; display:block; margin-bottom:4px;">Economic Feasibility</strong>
              <div style="font-size:15px; font-weight:600; color:#334155; line-height:1.48;">
          ...
          <div class="feasibility-card" style="border-left:5px solid #DC2626;">
            ...
            <div>
              <strong style="font-size:20px; font-weight:900; color:#0F172A; display:block; margin-bottom:4px;">Regulatory & Legal Feasibility</strong>
              <div style="font-size:15px; font-weight:600; color:#334155; line-height:1.48;">
        ...
        <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:14px 20px; display:flex; gap:18px; align-items:center;">
          <div style="width:130px; text-align:center; flex-shrink:0;">
            ...
            <div style="font-size:13px; font-weight:900; color:#0369A1; margin-top:4px;">22.4% CAGR</div>
          </div>
          <div style="border-left:1.5px solid #E2E8F0; padding-left:16px;">
            <strong style="font-size:17px; font-weight:800; color:#0F172A; display:block; margin-bottom:4px;">Market Viability & Sustainable Adoption</strong>
        ...
        <div style="display:flex; flex-direction:column; gap:12px; flex:1; justify-content:space-between;">
          ...
          <div class="challenge-card">
            <div style="display:flex; align-items:center; gap:10px;">
              <span style="background:#FEE2E2; color:#991B1B; font-size:13px; font-weight:900; padding:4px 10px; border-radius:4px;">CHALLENGE 01</span>
              <strong style="font-size:17.5px; font-weight:800; color:#0F172A;">Tor v3 Onion Routing & Origin Infrastructure Concealment</strong>
            </div>
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px;">
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#EFF6FF;">${ICONS.network}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">Active Misconfig Probing</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">Probes server status, mod_status, TLS SNI leakage, & Favicon MMH3 hashes to unmask clearnet host IP.</div>
                </div>
              </div>
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#F0FDF4;">${ICONS.shield}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">Future: Traffic Watermarking</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">Cross-relay NetFlow packet timing analysis correlates entry/guard circuits for deterministic de-anonymization.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="challenge-card">
            <div style="display:flex; align-items:center; gap:10px;">
              <span style="background:#FEF3C7; color:#92400E; font-size:13px; font-weight:900; padding:4px 10px; border-radius:4px;">CHALLENGE 02</span>
              <strong style="font-size:17.5px; font-weight:800; color:#0F172A;">Cross-Market Rebranding, Multiple Handles & Dialect Code-Switching</strong>
            </div>
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px;">
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#EFF6FF;">${ICONS.database}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">IndicBERT & PGP Correlator</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">Binds 4096-bit RSA keys across 15+ markets; extracts 284-dim stylometry embeddings with &gt; 88% match.</div>
                </div>
              </div>
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#F0FDF4;">${ICONS.cpu}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">Future: Diurnal Circadian Fusion</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">Maps UTC+5:30 sleep troughs and fuses cross-platform Telegram MTProto chat logs into unified persona models.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="challenge-card">
            <div style="display:flex; align-items:center; gap:10px;">
              <span style="background:#ECFDF5; color:#065F46; font-size:13px; font-weight:900; padding:4px 10px; border-radius:4px;">CHALLENGE 03</span>
              <strong style="font-size:17.5px; font-weight:800; color:#0F172A;">Securing 100% Admissibility in Cyber Courts Under BSA 2023 Sec 63</strong>
            </div>
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px;">
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#EFF6FF;">${ICONS.gavel}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">Asymmetric Fusion & HSM Seal</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">0.65 hard cap on AI stylometry; mandates deterministic cryptographic Merkle proof signed by FIPS 140-3 HSM.</div>
                </div>
              </div>
              <div class="mitigation-tile">
                <div class="mitigation-icon-box" style="background:#F0FDF4;">${ICONS.check}</div>
                <div>
                  <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:2px;">Future: Automated Court Dockets</strong>
                  <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.42;">One-click Section 94 BNSS digital summon generator and sealed forensic package prevent hostile witness acquittals.</div>
                </div>
              </div>
            </div>
          </div>
    ...
    # Slide 5: IMPACTS AND BENEFITS (Expanded height, large font >= 14.5px, bold promise)
    slide_5 = """case 5:
      return `<!DOCTYPE html>
<html>
<head>
  ...
  <div class="slide-5-container">
    ...
    <div style="display:grid; grid-template-columns: repeat(3, 1fr); gap:22px; margin-bottom:18px;">
      ...
      <div class="benefit-card" style="background:#FEF2F2; border:1.5px solid #FECACA;">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          <strong style="font-size:22px; font-weight:900; color:#991B1B;">Economic Benefits</strong>
          <span style="font-size:24px;">📊</span>
        </div>
        <div style="font-size:15.5px; font-weight:600; color:#334155; line-height:1.48;">
      ...
      <div class="benefit-card" style="background:#EFF6FF; border:1.5px solid #BFDBFE;">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          <strong style="font-size:22px; font-weight:900; color:#1E40AF;">Sovereign Security Benefits</strong>
      ...
      <div class="benefit-card" style="background:#ECFDF5; border:1.5px solid #A7F3D0;">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          <strong style="font-size:22px; font-weight:900; color:#065F46;">Evidentiary & Judicial Sovereignty</strong>
          <span style="font-size:24px;">⚖️</span>
        </div>
        <div style="font-size:15.5px; font-weight:600; color:#334155; line-height:1.48;">
    ...
    <div style="margin-bottom:18px;">
      <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:10px;">
        ...
        <div style="background:#EFF6FF; border:1.5px solid #BFDBFE; border-radius:9999px; padding:5px 20px; font-size:14.5px; font-weight:700; color:#1D4ED8;">Sample Operational Scenario</div>
      </div>
      ...
      <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:16px;">
        ...
        <div class="workflow-col">
          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:4px;">Incident Ingested</strong>
            <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.4;">Desk IO ingests seed .onion URL or extortion wallet from 1930 alert.</div>
          </div>
          <div style="display:flex; align-items:center; gap:8px; padding:6px 0;">
            <div style="width:30px; height:30px; border-radius:50%; background:#2563EB; color:#FFF; display:flex; align-items:center; justify-content:center; font-weight:900; font-size:15px;">1</div>
            <strong style="font-size:15px; font-weight:900; color:#0F172A;">CYBER CRIME IO</strong>
          </div>
          <div style="background:#EFF6FF; border:1px solid #BFDBFE; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15px; font-weight:800; color:#1E40AF; display:block; margin-bottom:4px;">Rapid Triage & Zero Backlog</strong>
            <div style="font-size:13.5px; font-weight:600; color:#334155; line-height:1.4;">Instant Tor reachability probe; priority scoring in &lt; 30 seconds eliminates triage fatigue.</div>
          </div>
        </div>
        ...
        <div class="workflow-col">
          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:4px;">Crawler Pool Active</strong>
            <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.4;">Rotating proxy circuits trigger mod_status, TLS SNI, & NTP timestamp audit.</div>
          </div>
          <div style="display:flex; align-items:center; gap:8px; padding:6px 0;">
            <div style="width:30px; height:30px; border-radius:50%; background:#059669; color:#FFF; display:flex; align-items:center; justify-content:center; font-weight:900; font-size:15px;">2</div>
            <strong style="font-size:15px; font-weight:900; color:#0F172A;">SCIENTIST 'D' (CUSTODIAN)</strong>
          </div>
          <div style="background:#ECFDF5; border:1px solid #A7F3D0; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15px; font-weight:800; color:#065F46; display:block; margin-bottom:4px;">Instant Origin Unmasked</strong>
            <div style="font-size:13.5px; font-weight:600; color:#334155; line-height:1.4;">Unmasks real hosting IP address; cuts darknet attribution from 14 days to &lt; 15 mins.</div>
          </div>
        </div>
        ...
        <div class="workflow-col">
          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:4px;">AI Cross-Validation</strong>
            <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.4;">IndicBERT & Siamese RoBERTa correlate forum handles & crypto across 15 markets.</div>
          </div>
          <div style="display:flex; align-items:center; gap:8px; padding:6px 0;">
            <div style="width:30px; height:30px; border-radius:50%; background:#D97706; color:#FFF; display:flex; align-items:center; justify-content:center; font-weight:900; font-size:15px;">3</div>
            <strong style="font-size:15px; font-weight:900; color:#0F172A;">SCIENTIST 'E' (AI LEAD)</strong>
          </div>
          <div style="background:#FEF3C7; border:1px solid #FDE68A; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15px; font-weight:800; color:#92400E; display:block; margin-bottom:4px;">Zero False Positive Chains</strong>
            <div style="font-size:13.5px; font-weight:600; color:#334155; line-height:1.4;">Multi-modal entity linkage achieves 94.2% attribution confidence, preventing dead ends.</div>
          </div>
        </div>
        ...
        <div class="workflow-col">
          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15.5px; font-weight:800; color:#0F172A; display:block; margin-bottom:4px;">Judicial Docket Signing</strong>
            <div style="font-size:14px; font-weight:600; color:#334155; line-height:1.4;">FIPS 140-3 HSM signs Sec 63 BSA certificate; compiles SHA-256 Merkle export.</div>
          </div>
          <div style="display:flex; align-items:center; gap:8px; padding:6px 0;">
            <div style="width:30px; height:30px; border-radius:50%; background:#DC2626; color:#FFF; display:flex; align-items:center; justify-content:center; font-weight:900; font-size:15px;">4</div>
            <strong style="font-size:15px; font-weight:900; color:#0F172A;">DIRECTOR / CYBER COURT</strong>
          </div>
          <div style="background:#FEF2F2; border:1px solid #FECACA; border-radius:8px; padding:12px 14px;">
            <strong style="font-size:15px; font-weight:800; color:#991B1B; display:block; margin-bottom:4px;">High Conviction Trial</strong>
            <div style="font-size:13.5px; font-weight:600; color:#334155; line-height:1.4;">Standardized Sec 63 BSA dockets lift trial conviction rates to 85%+; supports Sec 94 BNSS.</div>
          </div>
        </div>
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; gap:20px; background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:12px; padding:14px 20px;">
      ...
      <div style="display:flex; align-items:center; gap:12px;">
        <div style="background:#E5243B; color:#FFF; border-radius:8px; padding:8px 14px; text-align:center; font-weight:900; font-size:13.5px; line-height:1.2;">
          SDG 9<br><span style="font-size:11.5px; font-weight:600;">Industry &amp; Innovation</span>
        </div>
        <div style="background:#00689D; color:#FFF; border-radius:8px; padding:8px 14px; text-align:center; font-weight:900; font-size:13.5px; line-height:1.2;">
          SDG 16<br><span style="font-size:11.5px; font-weight:600;">Peace &amp; Justice</span>
        </div>
        <div style="background:#0F172A; color:#FFF; border-radius:8px; padding:8px 14px; text-align:center; font-weight:900; font-size:13.5px; line-height:1.2;">
          SURAKSHIT<br><span style="font-size:11.5px; font-weight:600;">Cyber Bharat</span>
        </div>
        <div style="background:#047857; color:#FFF; border-radius:8px; padding:8px 14px; text-align:center; font-weight:900; font-size:13.5px; line-height:1.2;">
          DIGITAL<br><span style="font-size:11.5px; font-weight:600;">India Mission</span>
        </div>
      </div>

      <!-- Formula Block -->
      <div style="background:#0F172A; border-radius:8px; padding:12px 20px; font-family:monospace; font-size:14.5px; color:#38BDF8; font-weight:700; line-height:1.45; text-align:center;">
    ...
    # Slide 6: RESEARCH AND REFERENCES (Zero 'Our Works', Replaced with Standards/RFCs Citations)
    slide_6 = """case 6:
      return `<!DOCTYPE html>
<html>
<head>
    ...
    <div style="display:grid; grid-template-columns: 48% 52%; grid-template-rows: 1fr 1fr; gap:18px; flex:1; margin-bottom:12px;">
      ...
      <div class="quadrant-box">
        ...
        <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:8px; background:#F8FAFC; border:1px solid #E2E8F0; border-radius:8px; padding:8px 12px; text-align:center;">
          <div>
            <div style="font-size:11.5px; font-weight:800; color:#64748B; text-transform:uppercase;">Nodes</div>
            <div style="font-size:17px; font-weight:900; color:#0F172A;">100 Units</div>
          </div>
          <div>
            <div style="font-size:11.5px; font-weight:800; color:#64748B; text-transform:uppercase;">Appliance</div>
            <div style="font-size:17px; font-weight:900; color:#0F172A;">₹48,000</div>
          </div>
          <div>
            <div style="font-size:11.5px; font-weight:800; color:#64748B; text-transform:uppercase;">Cloud / Mo</div>
            <div style="font-size:17px; font-weight:900; color:#0F172A;">₹3.2L/mo</div>
          </div>
          <div>
            <div style="font-size:11.5px; font-weight:800; color:#64748B; text-transform:uppercase;">Yr-1 Revenue</div>
...
"""
    ...
    print("Generated generate_bhedak_slides.mjs successfully!")
